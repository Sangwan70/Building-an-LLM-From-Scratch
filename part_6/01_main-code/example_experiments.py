...
#
# Code to run the Examples; see additional_examples.ipynb for more information
...
if __name__ == "__main__":
    ...
    if args.Example_solution == "baseline":
        main()
    elif args.Example_solution == "mask_instructions":
        main(mask_instructions=True)
    elif args.Example_solution == "alpaca_52k":
        main(alpaca52k=True)
    elif args.Example_solution == "phi3_prompt":
        main(phi3_prompt=True)
    elif args.Example_solution == "lora":
        main(lora=True)
    else:
        raise ValueError(f"{args.Example_solution} is not a valid --args.Example_solution option. Options: {options}")
