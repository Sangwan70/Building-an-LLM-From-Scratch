...
#   
# Code: https://github.com/Sangwan70/Building-an-LLM-From-Scratch.git
...
def get_model_and_tokenizer():
    """
    Code to load a GPT-2 model with finetuned weights generated in part 6.
    This requires that you run the code in part 6 first, which generates the necessary gpt2-medium355M-sft.pth file.
    """
    ...
    model_path = Path("..") / "01_main-code" / "gpt2-medium355M-sft.pth"
