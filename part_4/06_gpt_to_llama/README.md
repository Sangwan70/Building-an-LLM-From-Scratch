...
This folder contains code for converting the GPT implementation from part 4 and 5 to Meta AI's Llama architecture in the following recommended reading order:
