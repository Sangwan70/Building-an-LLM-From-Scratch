...
#
# A minimal instruction finetuning file based on the code in part 6
...
def main(test_mode=False):
    ...
    # Code as it is used in the main part
    else:
        BASE_CONFIG = {
    ...
    path = "../../gpt2/"
    file_name = f"{path}{re.sub(r'[ ()]', '', CHOOSE_MODEL) }-sft-standalone.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=("This flag runs the model in test mode for internal testing purposes. "
              "Otherwise, it runs the model as it is used in the part (recommended).")
    )
