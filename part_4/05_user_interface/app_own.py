...
# Source for "Building an LLM From Scratch"
#  
...
def get_model_and_tokenizer():
    """
    Code to load a GPT-2 model with pretrained weights generated in part 5.
    ...
    model_path = Path("..") / ".." / "gpt2" / "model.pth"
    if not model_path.exists():
        print(f"Could not find the {model_path} file. Please run the part 4 code (part_4.ipynb) to generate the model.pth file.")
        sys.exit()
